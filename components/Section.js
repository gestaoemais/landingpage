      ...
      <section id="aboutus" className="section__wrap">
        <Container>
          ...
          <Row className="align-items-center justify-content-between mb-lg-100">
            ...
            <Col lg="5">
              <h4 className="inner_box__title">Conheça a nossa história</h4>
              <p>
                A Gestão & Mais atua há mais de 10 anos no mercado, onde oferece
                um leque de ações pras empresas que estão mercado, assessorando
                as mesmas a se desenvolverem através de nossos produtos e
                serviços. Dentre eles, enfatizamos os nossos serviços de
                Treinamentos, Recrutamento e Seleção, Eventos , Locação de salas
                para reuniões e palestras, Missão-Executivas , dentre outras
                ações.
              </p>
            </Col>
          </Row>
          <Row className="justify-content-between">
            <Col md="3">
              ...
              <p>
                Oferecer soluções para a área da gestão de empresas que atuam
                nos diferentes segmentos de mercado, estimulando o
                empreendedorismo prezando pela qualidade, confiabilidade e
                competitividade
              </p>
            </Col>
            <Col md="3">
            ...
            <Col md="3">
              ...
              <p className="mb-0">
                Tornar-se uma escola de negócios, atuando de forma ampla na área
                de educação corporativa, buscando ser referência no estado do
                Piauí em um prazo de 10 anos.
              </p>
            </Col>
          </Row>
        </Container>
        ...
        <Container>
          ...
          <Row>
            ...
            <Box
              ...
              boxtext="Estamos na era do conhecimento e com isso o mercado de trabalho exige que os profissionais tenham um nível de qualificação elevado."
              modalContent_1="Estamos na era do conhecimento e com isso o mercado de trabalho exige que os profissionais tenham um nível de qualificação elevado para que possam corresponder a política de competitividade das empresas, onde através de um aperfeiçoamento com um carga-horária ampla e robusta poderá ser possivel a chegar esse patamar. Em virtude desse cenário, ofertamos várias especializações  a nível de lato sensu , como logistica empresarial, MBA em gestão de Pessoas, adm. da produção, Adm. financeira , liderança e gestão empresarial, além de outras. Todas tendo uma grade curricular dinâmica e condizente com o mercado, além de possuirmos um  corpo docente contendo   professores mestres e doutores, Todos com sólida vivencia acadêmica e de mercado,  contribuindo assim de forma significativa  junto aos programas de educação corporativa  desenvolvida por nossa instituição."
            />
            <Box
              icon="pencil-ruler"
              boxtitle="Cursos Técnicos"
              boxtext={`Curso Técnico de Recursos Humanos - Curso Técnico de Logitica - Curso Técnico em Cuidador de Idoso`}
              modalContent_1="Os cursos Técnicos tem uma possibilidade de ingresso mais rápido no mercado de trabalho ,
              onde os mesmos se caracterizam por um embasamento mais prático do que teórico, por isso
              que estão no alvo de muitos jovens nos centros urbanos. Ciente desse cenário, a Gestão&Mais
              estará ofertando brevemente vários cursos tecnicos como o de Recursos Humanos, Logitica e o de
              Cuidador de Idoso. Aguardem!"
            />
            <Box
              icon="tools"
